...
infinite resolution and it is light weight meaning it has a low loading time regardless of the connectivity or framework of the device.

I have created them to be used as a loading animation any time there is a background process or stall on the platform eg; loading up a new page
